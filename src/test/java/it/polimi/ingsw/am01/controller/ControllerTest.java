...
class ControllerTest {
    ...
    abstract class WithUtils {
        ...
        void prepare_SETUP_OBJECTIVE() throws IllegalGameStateException, PlayerNotInGameException, NotAuthenticatedException, GameNotFoundException, DoubleChoiceException, InvalidSideException, InvalidMaxPlayersException, NameAlreadyTakenException, PlayerAlreadyPlayingException {
        ...
        void prepare_PLAY_PLACING() throws IllegalGameStateException, PlayerNotInGameException, NotAuthenticatedException, GameNotFoundException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException, InvalidMaxPlayersException, NameAlreadyTakenException, PlayerAlreadyPlayingException {
    ...
    class PlaceCard extends WithUtils {
        ...
        @BeforeEach
        void init() throws IllegalGameStateException, PlayerNotInGameException, NotAuthenticatedException, GameNotFoundException, InvalidObjectiveException, DoubleChoiceException, InvalidSideException, InvalidMaxPlayersException, NameAlreadyTakenException, PlayerAlreadyPlayingException {
            this.prepare_PLAY_PLACING();
        }
