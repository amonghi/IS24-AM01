...
class GameTest {
    ...
    @Test
    public void testOneTurnPerPlayerWithPause() throws IllegalGameStateException, PlayerNotInGameException, IllegalTurnException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
        standardGame.join(p1);
        standardGame.join(p2);
        standardGame.join(p3);
        standardGame.join(p4);
    ...
    @Test
    public void firstTestEndGameDeckEmpty() throws IllegalGameStateException, InvalidMaxPlayersException, PlayerNotInGameException, IllegalTurnException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
    ...
    @Test
    public void secondTestEndGameDeckEmpty() throws IllegalGameStateException, PlayerNotInGameException, IllegalTurnException, InvalidMaxPlayersException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
    ...
    @Test
    public void firstTestEndGameTwentyPoints() throws IllegalGameStateException, PlayerNotInGameException, IllegalTurnException, PlayerAlreadyPlayingException, InvalidMaxPlayersException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
    ...
    @Test
    public void secondTestEndGameTwentyPoints() throws InvalidMaxPlayersException, IllegalGameStateException, PlayerNotInGameException, IllegalTurnException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
        List<Card> cards = new ArrayList<>();
    ...
    @Test
    public void testNotPlayerTurn() throws IllegalGameStateException, PlayerNotInGameException, IllegalTurnException, CardNotInHandException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException, IllegalPlacementException {
        standardGame.join(p1);
        standardGame.join(p2);
        standardGame.join(p3);
        standardGame.join(p4);
    ...
    @Test
    public void testCardNotInHand() throws IllegalGameStateException, PlayerNotInGameException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
        standardGame.join(p1);
        standardGame.join(p2);
        standardGame.join(p3);
        standardGame.join(p4);
    ...
    @Test
    public void testNotEnoughCards() throws InvalidMaxPlayersException, IllegalGameStateException, PlayerNotInGameException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
    ...
    @Test
    public void testDecksAreEmptyOnStarting() throws InvalidMaxPlayersException, IllegalGameStateException, PlayerNotInGameException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
    ...
    @Test
    public void testPlayerIsNotInGame() throws IllegalGameStateException, PlayerNotInGameException, CardNotInHandException, IllegalTurnException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException, IllegalPlacementException {
        standardGame.join(p1);
        standardGame.join(p2);
        standardGame.join(p3);
        standardGame.join(p4);
    ...
    @Test
    public void testEndGameTwentyPointsWithEarlyStart() throws InvalidMaxPlayersException, IllegalGameStateException, PlayerNotInGameException, NotEnoughPlayersException, IllegalTurnException, PlayerAlreadyPlayingException, DoubleChoiceException, InvalidSideException, InvalidObjectiveException {
        List<Card> cards = new ArrayList<>();
